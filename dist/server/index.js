...
function getDraftSecret() {
	return "7931be99-08b6-4f89-8d40-4f5c4653fd79";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "79269c94-0894-4fdb-8eef-5ffae2db3484";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "79269c94-0894-4fdb-8eef-5ffae2db3484") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "79269c94-0894-4fdb-8eef-5ffae2db3484",
		rootBoundaryId
	});
}
/**
